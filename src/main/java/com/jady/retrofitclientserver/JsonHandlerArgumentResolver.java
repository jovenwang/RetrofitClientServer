...
//        RequestConverter message = RequestHelper.getRequestConverter();
////        return message.getBody(parameter.getParameterType());
        return jsonParseBody(webRequest.getParameterMap(),parameter.getParameterType());
    }
    ...
    public <T> T jsonParseBody(Map body, Class<T> clazz) {
        ...
        T t = null;
        try {
            Method method = clazz.getMethod("parseBody", Map.class,Class.class);
